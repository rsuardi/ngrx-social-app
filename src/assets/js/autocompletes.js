...
$(document).ready((function () {
    ...
    if ($("#mood-autocpl").length) {
        ...
        var d = {
            ...
            list: {
                ...
                onChooseEvent: function () {
                    var e = $("#mood-autocpl").val(),
                        t = $("#mood-autocpl").getSelectedItemData().pic;
    ...
    if ($("#drinking-autocpl").length) {
        ...
        var m = {
            ...
            list: {
                ...
                onChooseEvent: function () {
                    var e = $("#drinking-autocpl").val(),
                        t = $("#drinking-autocpl").getSelectedItemData().pic;
    ...
    if ($("#eating-autocpl").length) {
        ...
        var u = {
            ...
            list: {
                ...
                onChooseEvent: function () {
                    var e = $("#eating-autocpl").val(),
                        t = $("#eating-autocpl").getSelectedItemData().pic;
    ...
    if ($("#watching-autocpl").length) {
        ...
        var g = {
            ...
            list: {
                ...
                onChooseEvent: function () {
                    var e = $("#watching-autocpl").val(),
                        t = $("#watching-autocpl").getSelectedItemData().pic;
    ...
    if ($("#travel-autocpl").length) {
        ...
        var h = {
            ...
            list: {
                ...
                onChooseEvent: function () {
                    var e = $("#travel-autocpl").val(),
                        t = $("#travel-autocpl").getSelectedItemData().pic;
    ...
    $("#location-autocpl").length && $((function () {
        ...
        a = new google.maps.places.Autocomplete(t, {
            types: ["(cities)"]
        }), $("#go").click((function () {
            var t = a.getPlace();
            ...
            e.geocode({
                ...
                for (i = 0; i < a.length; i++)
                    for (var e = 0; e < a[i].address_components.length; e++)
                        for (var t = 0; t < a[i].address_components[e].types.length; t++) "postal_code" == a[i].address_components[e].types[t] && (zipcode = a[i].address_components[e].short_name, $("span.zip").html(zipcode))
            }))
        }))
    }))
}));
