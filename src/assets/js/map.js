...
$(document).ready((function () {
    initMapBox(), $(".map-box").on("click", (function () {
        ...
        var e = $(this).attr("data-lat"),
            a = $(this).attr("data-long"),
            t = parseInt($(this).attr("data-feature")),
            o = document.getElementsByClassName("mapboxgl-popup");
        o.length && o[0].remove(), map.flyTo({
            center: [e, a],
            zoom: 15,
            bearing: 0,
            essential: !0
        });
        var s = locations.features[t].properties.name,
            n = locations.features[t].properties.logo,
            r = locations.features[t].properties.distance;
        new mapboxgl.Popup({
            closeOnClick: !1
        }).setLngLat([e, a]).setHTML('\n          <div class="map-box-location">\n            <div class="map-box-header">\n              <div class="media-flex-center">\n                <div class="avatar-wrap">\n                  <img\n                    class="avatar"\n                    src="' + ("development" === env ? n : "https://via.placeholder.com/150x150") + '"\n                    alt=""\n                  />\n                </div>\n                <div class="flex-meta">\n                  <span class="is-dark-heading">' + s + "</span>\n                  <span>" + r + " mile(s)</span>\n                </div>\n              </div>\n            </div>\n          </div>\n        ").addTo(map)
