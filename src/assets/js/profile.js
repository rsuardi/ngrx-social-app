...
$(document).ready((function () {
    ...
    if ($(".avatar-button").on("click", (function () {
        ...
        $("#upload-cover-picture").on("change", (function () {
            ...
            $(this).addClass("is-loading"), i.croppie("result", {
                type: "canvas",
                size: "original"
            }).then((function (e) {
                var i, o;
                console.log("RESP:", e), (i = {
                    src: e
                }).html && (o = i.html, console.log("HTML RESULT", o)), i.src && (o = '<img src="' + i.src + '" />', console.log(o), $(".cover-image").attr("src", i.src), $("#submit-cover-picture").removeClass("is-loading"), $("#upload-crop-cover-modal").removeClass("is-active"))
            }))
    ...
    if ($("#upload-profile").length) {
        ...
        $("#upload-profile-picture").on("change", (function () {
            ...
            $(this).addClass("is-loading"), o.croppie("result", {
                type: "canvas",
                size: "viewport"
            }).then((function (e) {
                var i;
                (i = {
                    src: e
                }).html && i.html, i.src && (i.src, $(".cover-bg .avatar .avatar-image, #user-avatar-minimal").attr("src", i.src), $("#submit-profile-picture").removeClass("is-loading"), $("#upload-crop-profile-modal").removeClass("is-active"))
            }))
