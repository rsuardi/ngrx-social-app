...
$(document).ready((function () {
    if ($(".settings-wrapper").length) {
        ...
        if ($(".settings-sidebar .menu-block li").on("click", (function () {
            var t = $(this).attr("data-section");
            $(".settings-sidebar .menu-block li").removeClass("is-active"), $(this).addClass("is-active"), $(".settings-wrapper .settings-section, .tip-group").removeClass("is-active"), $("#" + t + "-settings").addClass("is-active"), $("#" + t + "-tips").addClass("is-active")
